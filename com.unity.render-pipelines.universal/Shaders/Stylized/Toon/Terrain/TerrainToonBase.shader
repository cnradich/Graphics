Shader "Hidden/Universal Render Pipeline/Stylized/Terrain/Toon (Base Pass)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Shaders/Stylized/Toon/Terrain/TerrainToonInput.hlsl"
            #include "Packages/com.unity.render-pipelines.universal/Shaders/Stylized/Toon/Terrain/TerrainToonMetaPass.hlsl"
