#ifndef UNIVERSAL_TERRAIN_TOON_INPUT_INCLUDED
#define UNIVERSAL_TERRAIN_TOON_INPUT_INCLUDED
...
inline void InitializeToonSurfaceData(float2 uv, out ToonSurfaceData surfaceData)
{
    surfaceData.baseColor = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, uv);
