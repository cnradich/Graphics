Shader "HDRP/Toon"
{
    Properties
    {
        ...
        [MainColor] _ToonColor("Color", Color) = (1,1,1,1)
        [MainTexture] _ToonColorMap("ColorMap", 2D) = "white" {}
        ...
        [HideInInspector] _ToonColorMap_MipInfo("_ToonColorMap_MipInfo", Vector) = (0, 0, 0, 0)
    }
    ...
    #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/ToonProperties.hlsl"
    ...
    SubShader
    {
        ...
        Tags{ "RenderPipeline" = "HDRenderPipeline" "RenderType" = "HDToonShader" }
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/Toon.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/ShaderPass/ToonDepthPass.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/ToonData.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/Toon.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/ShaderPass/ToonSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/ToonData.hlsl"
        ...
        // Toon shader always render in forward
        Pass
        {
            Name "ForwardOnly"
            ...
            #define SHADERPASS SHADERPASS_FORWARD_TOON

            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/Toon.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/ShaderPass/ToonSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/ToonData.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/RenderPipeline/ShaderPass/ShaderPassForwardToon.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Material.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/Toon.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/ShaderPass/ToonDistortionPass.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/ToonData.hlsl"
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/ToonData.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Toon/ToonRaytracing.hlsl"
    ...
    CustomEditor "Rendering.HighDefinition.ToonGUI"
}
