...
{
    /// <summary>
    /// The UI block that represents common properties for toon Shader Graphs.
    /// </summary>
    public class ToonShaderGraphGUI : HDShaderGUI
    {
        const SurfaceOptionUIBlock.Features surfaceOptionFeatures = SurfaceOptionUIBlock.Features.Toon;
        ...
        MaterialUIBlockList m_UIBlocks = new MaterialUIBlockList
        {
            ...
            new ShaderGraphUIBlock(MaterialUIBlock.ExpandableBit.ShaderGraph, ShaderGraphUIBlock.Features.Toon),
        ...
        /// <summary>
        /// Sets up the keywords and passes for the Toon Shader Graph material you pass in.
        /// </summary>
        ...
        public static void SetupToonKeywordsAndPass(Material material)
        {
            ...
            ToonGUI.SetupToonKeywordsAndPass(material);
        }
