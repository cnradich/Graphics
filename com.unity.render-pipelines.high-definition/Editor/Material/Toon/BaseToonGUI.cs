...
{
    // Extension class to setup material keywords on toon materials
    static class BaseToonGUI
    {
        public static void SetupBaseToonKeywords(this Material material)
        {
            ...
            if (material.HasProperty(kZTestDepthEqualForOpaque))
            {
                ...
                {
                    // When the material is after post process, we need to use LEssEqual because there is no depth prepass for toon opaque
            ...
            material.SetupMainTexForAlphaTestGIToon("_ToonColorMap", "_ToonColor");
        ...
        public static void SetupMainTexForAlphaTestGIToon(this Material material, string colorMapPropertyName, string colorPropertyName)
        {
        ...
        static public void SetupBaseToonPass(this Material material)
        {
            ...
            if (!material.shader.IsShaderGraph())
            {
                ...
                // We don't have any vertex animation for lit/toon vector, so we
